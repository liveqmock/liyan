 ...
 * @version 1.0
 */
public class PdfFormReportSerivceImpl extends AbstractReportFactory implements
		PdfFormReportService {

	public PdfFormReportSerivceImpl() throws Exception {
		super();
	}

	/*
	 * (non-Javadoc)
	 * @see com.bstek.bdf.report.pdf.service.PdfFormReportService#generateFormReport(com.bstek.bdf.report.model.ReportTitleModel, java.util.Collection, java.io.OutputStream)
	 */
	public void generateFormReport(ReportTitleModel reportTitle,
			Collection<ReportFormModel> reportFormModels, OutputStream out)
			throws Exception {
