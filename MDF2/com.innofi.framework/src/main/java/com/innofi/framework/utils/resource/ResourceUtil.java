package com.innofi.framework.utils.resource;
 ...
 * for handling all kinds of file resource in a uniform manner.
 * {@link org.springframework.core.io.ResourceLoader}'s <codebuilder>getResource</codebuilder>
 * method can resolve any location to a {@link org.springframework.core.io.Resource}
 * object, which in turn allows to obtain a <codebuilder>java.io.File</codebuilder> in the
 * file system through its <codebuilder>getFile()</codebuilder> method.
 * <p/>
...
public abstract class ResourceUtil {
    ...
    /**
     * URL protocol for an entry from an OC4J jar file: "codebuilder-source"
     */
    public static final String URL_PROTOCOL_CODE_SOURCE = "codebuilder-source";
    ...
    /**
     * Resolve the given resource location to a <codebuilder>java.net.URL</codebuilder>.
    ...
    /**
     * Resolve the given resource location to a <codebuilder>java.io.File</codebuilder>,
    ...
    /**
     * Resolve the given resource URL to a <codebuilder>java.io.File</codebuilder>,
     * i.e. to a file in the file system.
     *
    ...
    /**
     * Resolve the given resource URI to a <codebuilder>java.io.File</codebuilder>,
     * i.e. to a file in the file system.
     *
     ...
     * that is, has protocol "jar", "zip", "wsjar" or "codebuilder-source".
     * <p>"zip" and "wsjar" are used by BEA WebLogic Server and IBM WebSphere, respectively,
     * but can be treated like jar files. The same applies to "codebuilder-source" URLs on Oracle
     ...
     * in contrast to the <codebuilder>URL.toURI()</codebuilder> method.
     *
     ...
     * @return the URI instance
     * @throws java.net.URISyntaxException if the location wasn't a valid URI
     */
     ...
     * given connection, preferring <codebuilder>false</codebuilder> but leaving the
     * flag at <codebuilder>true</codebuilder> for JNLP based resource.
     *
