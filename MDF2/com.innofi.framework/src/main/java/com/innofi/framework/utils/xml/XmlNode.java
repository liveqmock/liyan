 ...
 */
public abstract interface XmlNode {
     ...
     * @return 添加的XmlNode对象
     */
    public abstract XmlNode addChild(String nodeName);
     ...
     * @return 添加的XmlNode对象
     */
    public abstract void addChild(XmlNode paramXmlNode);
     ...
     * @return 子XmlNode对象
     */
    public abstract XmlNode getChild(String nodeName);
     ...
     * @return 子XmlNode数组
     */
    public abstract XmlNode[] getChildren();
     ...
     */
    public abstract XmlNode getNodeByXPath(String xp);
     ...
     */
    public abstract XmlNode[] getNodesByXPath(String xp);
     ...
     */
    public abstract XmlNode cloneNode() throws CloneNotSupportedException;
