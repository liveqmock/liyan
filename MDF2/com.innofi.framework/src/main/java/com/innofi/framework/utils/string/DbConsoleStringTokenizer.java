...
//todo
public class DbConsoleStringTokenizer {
    ...
    public DbConsoleStringTokenizer() {
    }

    public DbConsoleStringTokenizer(String aSource, String delimiter) {
        this(delimiter, false, "\"", false);
        this.setSourceString(aSource);
    }

    public DbConsoleStringTokenizer(char delimChar, String quotingChars, boolean keep) {
        this(String.valueOf(delimChar), quotingChars, keep);
    }

    public DbConsoleStringTokenizer(String aDelim, String quotingChars, boolean keep) {
        this.delimit = aDelim;
     ...
     * setSourceString()
     */
    public DbConsoleStringTokenizer(String aDelim, boolean isSingleDelimiter, String quotingChars, boolean keep) {
        this.delimit = aDelim;
    ...
    public DbConsoleStringTokenizer(String input, String aDelim, boolean isSingleDelimiter, String quotingChars, boolean keepQuotes) {
        this.delimit = aDelim;
        this.singleWordDelimiter = isSingleDelimiter;
        this.quoteChars = quotingChars;
